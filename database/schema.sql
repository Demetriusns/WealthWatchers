...
ALTER TABLE `ai_forecasts`
  ...
  ADD KEY `fk_AI_forecasts_users_idx` (`user_id`);
...
--
ALTER TABLE `ai_forecasts`
  ADD CONSTRAINT `fk_AI_forecasts_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
